...
<body>
  <div id="main">
    ...
    int waterCharges = 0;
    int sewageCharges = 0 ;
    int garbageCharges = 0;
    int rent = 0 ;
    int totalCharges = 0;
    
    String query = "SELECT Distinct Apartment_Number, Apartment_Type, Apartment_water_charges, Apartment_sewage_charges, Apartment_garbage_charges, Apartment_Rent, " +
            " Apartment_water_charges + Apartment_sewage_charges + Apartment_garbage_charges + Apartment_Rent " +        
    ...
    if(rs.next()){ 
        ...
        waterCharges = rs.getInt(3);
        sewageCharges = rs.getInt(4);
        garbageCharges = rs.getInt(5);
        rent = rs.getInt(6);
        totalCharges = rs.getInt(7);
    }
 %>
        ...
        <form method="post" action="payment.jsp">
            <center>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Payment Type</td>
                        <td><input type="text" name="paymentType" value="" class="inputText"/> </td>
                    </tr>
                    <tr>
                        <td>Account Details</td>
                        <td><input type="text" name="accountDetails" value="" class="inputText"/> </td>
                    </tr>
                    <tr>
                        <td>Rent Date (From)</td>
                        <td><input type="text" name="startDate" value="" class="inputText"/> </td>
                    </tr>
                    <tr>
                        <td>Rent Date (To)</td>
                        <td><input type="text" name="endDate" value="" class="inputText"/> </td>
                    </tr>
                    <tr>
                        <td>Enter Amount</td>
                        <td><input type="text" name="amount" value="" class="inputText"/> </td>
                    </tr>
                    <tr>
