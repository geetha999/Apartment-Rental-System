	...
	<!-- <div style="width: 940px; height: 800px; float: left;"> -->
	  ...
	  <div id="content">
              <div class="content_item">
                  ...
                  <h1>OOh!!!!! Allotment Process has Some Exceptions.
        <p><% out.println(session.getAttribute("exceptionMessage")); %>
        <p>Try Again <a href='apartmentAllotmentForm.jsp'>Register New Tenant</a>
        <p>Back to Home <a href='adminportal.jsp'> Home</a>
        </h1>
