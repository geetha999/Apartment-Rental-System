	...
	<!-- <div style="width: 940px; height: 800px; float: left;"> -->
	  ...
	  <div id="content">
              <div class="content_item">
                  ...
                  <h1>Registration is Successful.
            <p> Another Registration <a href='apartmentAllotmentForm.jsp'>New Tenant Registration</a>
            <p>
                Back to Home <a href='adminportal.jsp'>Home</a> 
