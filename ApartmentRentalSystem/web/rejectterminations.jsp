...
try {
    ...
    if(id[i] != null){
        st.executeUpdate("UPDATE Termination set  Termination_Status='Rejected' WHERE Termination_ID = " + Integer.parseInt(id[i])+ ""); %>
        <h1>Termination request rejected Successfully</h1>
