  ...
  <div id="main">
	...
	<!-- <div style="width: 940px; height: 800px; float: left;"> -->
	  ...
	  <div id="content">
        ...
        <h1>OOh!!!!! Renewal Request Process has Some Exceptions.</h1>
        <% out.println(session.getAttribute("exceptionMessage")); %>
        Try Again <a href='renewalrequestform.jsp'> Renewal Request</a>
        Back to <a href='tenantportal.jsp'> Home Page</a>
